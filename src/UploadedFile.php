...
use Janmas\Upload\Exception\FileException;
...
class UploadedFile extends File
{
    ...
    public function move(string $directory, string $name = null): File
    {
        if ($this->isValid()) {
            ...
            if (!$moved) {
                throw new FileException($this->getPathname(), sprintf('Could not move the file "%s" to "%s" (%s)', $this->getPathname(), $target, strip_tags($error)));
            }
        ...
        throw new FileException($this->getPathname(), $this->getErrorMessage());
    }
